...
<p align="center">
  <img src="https://github-profile-trophy.vercel.app/?username=lnv-louis&theme=darkhub&no-frame=false&no-bg=false&row=1&column=7" alt="GitHub Trophies" />
</p>
...
**🏆 1st Place Winner, Lovable Hackathon**
AI Fact-Checking Platform with deep analysis of any public-facing news article. Multi-stage prompt chain with Perplexity's Sonar Pro analyzing 6+ sources per query.
...
**🏆 6th Place Winner, Cursor London**
Real-time face recognition for Hackathons & Networking Events. Identifies attendees in <5 seconds using Facenet512 and RetinaFace.
...
### [🎵 MRAE - Memory-Retrieved Album Explorer](https://github.com/lnv-louis/mrae)
Built for Mobile AI Hackathon: Cactus X Nothing X Hugging Face.

![TypeScript](https://img.shields.io/badge/TypeScript-007ACC?style=flat-square&logo=typescript&logoColor=white)
![React](https://img.shields.io/badge/React-20232A?style=flat-square&logo=react&logoColor=61DAFB)

### [📅 UCL Calendar Scraper](https://github.com/lnv-louis/ucl-calendar-scraper)
Google Apps Script project for a True Attendance Tracker which scrapes all events from your dedicated UCL Calendar and initializes a new sheet with attendance data.
...
R scripts for RF and RBF-SVM for Acute Myeloid Leukemia subtypes multiclass classification using gene expression profiles. Achieved 82% accuracy.
...
Comparative analysis of Bidirectional LSTM and LinearSVC for sentiment classification on ~5k financial news headlines. LinearSVC achieved F1 of 0.74.
...
<p align="center">
  <i>"From MVPs to PMFs—building AI products that ship fast and scale intelligently."</i>
</p>
